 ...
 * name: `@fleximap/preset-urban` pulls in the draw, edit, snap, select, measure,
...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@fleximap/plugin-edit': pkg('plugin-edit/src/index.ts'),
      '@fleximap/plugin-snap': pkg('plugin-snap/src/index.ts'),
      '@fleximap/plugin-select': pkg('plugin-select/src/index.ts'),
      '@fleximap/plugin-measure': pkg('plugin-measure/src/index.ts'),
      '@fleximap/plugin-history': pkg('plugin-history/src/index.ts'),
      '@fleximap/plugin-topology': pkg('plugin-topology/src/index.ts'),
      '@fleximap/plugin-ui': pkg('plugin-ui/src/index.ts'),
      '@fleximap/preset-urban': pkg('preset-urban/src/index.ts'),
    },
  },
  /*
   * `createFlexiMap()` is async — the renderer must mount and every plugin's `setup`
