---
'@blaeu/core': patch
'@blaeu/plugin-draw': patch
'@blaeu/plugin-edit': patch
'@blaeu/plugin-history': patch
'@blaeu/plugin-measure': patch
'@blaeu/plugin-select': patch
'@blaeu/plugin-snap': patch
'@blaeu/plugin-topology': patch
'@blaeu/plugin-ui': patch
'@blaeu/preset-cadastre': patch
'@blaeu/preset-game': patch
'@blaeu/preset-urban': patch
---

Close the ingest gate, fix four lifecycle seams, and make the packages installable.
